...
- [[concepts/second-order-thinking]] - Ask what happens after the first-order promise or policy.
- [[concepts/confidence-cycle]] - Public confidence and anger can become self-reinforcing.
- [[concepts/credit-cycle]] - Credit booms are another case where short-term benefits hide delayed costs.
- [[concepts/decision-quality-vs-outcome]] - A decision should be judged by process and probabilities, not only by whether it wins a vote or produces an immediate benefit.
