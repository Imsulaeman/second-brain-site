...
1. **Switch from [[concepts/focused-vs-diffuse-thinking|focused to diffuse mode]]** — take a break, go for a walk, sleep on it
2. **Deliberately try different approaches** — force yourself to abandon your first idea
3. **Study with others** — other people's different [[concepts/chunking|chunks]] can reveal your blind spots
4. **Use analogies and metaphors** — they can reframe the problem structure
