...
title: "Inferencing"
type: concept
tags: [reading, reasoning, comprehension, critical-thinking]
created: 2026-06-06
updated: 2026-06-06
sources: 1
---
...
This means inferencing sits between raw observation and full explanation. It is stronger than a hunch because it is text-bound, but weaker than deduction because the conclusion is not forced with certainty. In practice, good inferencing often looks like disciplined [[concepts/inductive-reasoning|inductive reasoning]] carried out on a small local sample.

## Two Common Kinds

1. **Detail inference.** A reader infers an unstated fact, motive, feeling, or implication from a specific passage.
2. **Main-idea inference.** A reader reconstructs the governing claim of a paragraph or section when the author leaves it implicit.
