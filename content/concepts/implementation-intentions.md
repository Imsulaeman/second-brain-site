...
[[concepts/habit-stacking|Habit stacking]] is a special case where the "time" variable is replaced by an existing behavior. Both remove ambiguity; stacking is often more robust because it ties to a behavior you already do reliably.

---

## Connections

- **[[concepts/four-laws-of-behavior-change]]** — implementation intentions are the core tool of the 1st Law ("make it obvious")
- **[[concepts/environment-design-for-habits]]** — implementation intentions plan the behavior; environment design ensures the cues support it
- **[[concepts/decisive-moments]]** — pre-deciding at key junctures removes the need for in-the-moment willpower
