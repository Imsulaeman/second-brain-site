...
As laid out in [[sources/situational-awareness]] by [[entities/leopold-aschenbrenner]]:
...
1. **Chips**: SMIC can produce 7nm chips (~2-3x worse perf/$ than Nvidia, but functional)
2. **Infrastructure**: China has built as much new electricity capacity in the last decade as the entire current US capacity. Building 100GW clusters is easier for China.
3. **Algorithms**: On the current course, Chinese espionage can trivially steal the key algorithmic breakthroughs from poorly-secured US labs, potentially matching the US algorithmic edge.
