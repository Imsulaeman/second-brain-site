...
[[entities/barbara-oakley|Barbara Oakley]] uses a pinball machine analogy:
...
- The [[concepts/einstellung-effect|Einstellung Effect]] happens when focused mode locks you into a wrong approach
- [[concepts/chunking|Chunking]] depends on focused mode to form new chunks and diffuse mode to connect them to the bigger picture
- [[concepts/deliberate-practice|Deliberate Practice]] operates primarily in focused mode, but benefits from diffuse-mode breaks for consolidation
