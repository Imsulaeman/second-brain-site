...
| Type | Description | Permissioned? | Era |
|---|---|---|---|
| Labor | People working for you | Yes — requires followers | Pre-industrial |
...
This matters for [[concepts/specific-knowledge|specific knowledge]] because niche obsession can now find a niche audience. The internet connects every person to every other person. A pre-internet expert in a narrow domain was limited to their local market. Post-internet, the world's 50,000 people who care about exactly your thing are now reachable.
...
[[concepts/agentic-coding-workflows|AI coding agents]] are an extension of code leverage — they let judgment and task design produce output without requiring proportionally more labor. The bottleneck shifts from execution to the quality of what you tell the agents to do.
