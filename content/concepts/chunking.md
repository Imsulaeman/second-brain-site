...
**Mechanically:** a chunk is a set of neurons that have learned to fire together. Once wired, they activate as a unit from a single trigger. A chunk occupies only **one slot** in [[concepts/working-memory-vs-long-term-memory|working memory]] (~4 slots), but contains rich interconnected information underneath.
...
Both [[entities/barbara-oakley|Barbara Oakley]] and [[entities/justin-skycak|Justin Skycak]] describe expertise as having built a vast library of chunks:
...
[[concepts/perceptual-learning|Perceptual Learning]] is the perceptual side of chunking — experts literally *see* differently because their LTM chunks reshape what their working memory receives from sensory input.
