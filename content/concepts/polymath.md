...
**Serial vs. simultaneous.** Some polymaths master one field, then turn to another. Others work across multiple domains at once. The serial type can go deep in each; the simultaneous type risks the scattering that Burke calls the [[concepts/specialization#Leonardo syndrome|Leonardo syndrome]].
