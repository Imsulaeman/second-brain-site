...
Japanese for "change for the better." A philosophy of **continuous, incremental improvement** as a daily practice — done by everyone in the system, not just leadership or specialists. Originated as the cultural backbone of [[entities/toyota|Toyota's]] production system; now applied across manufacturing, software engineering, healthcare, and personal productivity.
...
- [[concepts/5-whys]] — when defects occur, drill to root cause before patching
...
Kaizen scales down to the individual. The James Clear / [[entities/james-clear|*Atomic Habits*]] model is essentially personal kaizen with American framing:

- 1% better daily ([[concepts/four-laws-of-behavior-change|four laws of behavior change]])
- Identity-based change ([[concepts/identity-based-habits]])
- Small wins compounding ([[concepts/plateau-of-latent-potential]])
...
- **Local optimization, global stagnation** — improving individual steps while the overall system has the wrong design. Kaizen alone can't fix a fundamentally broken architecture; you need [[concepts/first-principles-thinking|first-principles]] redesign for that.
...
- [[concepts/5-whys]] — kaizen's diagnostic tool of choice
- [[concepts/deliberate-practice]] — personal-skills version: improvement at the edge of ability
- [[concepts/first-principles-thinking]] — complement: kaizen optimizes within the current frame; first-principles asks if the frame is right
