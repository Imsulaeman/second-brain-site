...
What gives the essay weight is the historical after-check. Vietnam, Laos, and Cambodia did fall under communist rule, but the full catastrophic sequence that the theory implied never unfolded. Some feared consequences happened; the deterministic story did not. Worth keeping from this piece: when someone predicts disaster from a first step, ask for the exact intermediate links and for the probability of each one, not just for the vividness of the final outcome.
