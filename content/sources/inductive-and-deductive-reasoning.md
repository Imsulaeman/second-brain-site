...
| Category | Inductive reasoning | Deductive reasoning |
| --- | --- | --- |
| Direction | specific cases -> general conclusion | general rule -> specific conclusion |
| Output | likely conclusion | necessary conclusion, if premises and logic hold |
| Typical use | prediction, diagnosis, pattern-finding | proof, rule application, formal judgment |
| Main risk | the pattern may break | the premises may be false, or the logic invalid |
