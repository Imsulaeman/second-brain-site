...
**Type:** Essay — for otherwise-profitable traders who gave back meaningful gains
...
1. **Size up to win it back** — trade more aggressively, implicitly martingale the loss. Often works once, which is exactly why it's dangerous: reinforces a habit that is mathematically guaranteed to go to zero eventually.
2. **Burn out and walk away** — tell yourself there's no more edge, leave the game entirely. Self-defeating.
...
- [[sources/life-lessons-from-trading]] — broader trading psychology
- [[sources/the-jackpot-age]] — risk preferences and the mathematics of loss
