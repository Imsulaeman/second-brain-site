...
This TED talk by [[entities/eli-pariser|Eli Pariser]] argues that the web's personalization systems do not just make information more convenient. They quietly narrow it. The talk's central warning is that once platforms optimize too aggressively for relevance, clicks, and user history, people can end up living inside a [[concepts/filter-bubble|filter bubble]]: a customized information environment that feels complete from the inside while hiding what has been filtered out.
...
- `raw/Beware online filter bubbles (ingested).md`
