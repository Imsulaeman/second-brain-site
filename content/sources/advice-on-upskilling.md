...
- **[[concepts/spaced-repetition|Spaced Repetition]]:** "Wait"-lifting. Memory is strengthened by successfully retrieving *fuzzy* memory — the harder the lift, the stronger the muscle.
- **Recall First, Reason Second:** Always attempt recall before consulting reference material.
- **[[concepts/prereq-mastery|Prereq Mastery]]:** "Prereq yo' self before you wreck yo' self." Missing prerequisites don't just slow you down — they create vicious cycles that compound.
...
- **[[concepts/perceptual-learning|Perceptual Learning]]:** Experts don't just think differently — they *perceive* differently. The same sensory input is chunked into richer patterns automatically.
- **[[concepts/learning-is-memory|Learning is Memory]]:** Understanding is just well-connected, deeply ingrained memory. "Just memorizing" vs "deeply understanding" is not a categorical difference — it's a depth-of-encoding difference.
...
- [[entities/justin-skycak|Justin Skycak]] — author; math educator, founder of Math Academy
- [[entities/benjamin-bloom|Benjamin Bloom]] — cited for the Three Stages of Talent Development and for the schooling vs talent development distinction
