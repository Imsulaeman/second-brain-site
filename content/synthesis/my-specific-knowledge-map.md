---
title: "My Specific Knowledge Map"
type: synthesis
tags: [specific-knowledge, self-knowledge, learning, trading, ai-coding, leverage, naval, howard-marks]
created: 2026-05-11
updated: 2026-05-11
sources: 10
---
...
```mermaid
flowchart TD
    A["Sources you ingest"] --> B["Recurring themes"]
    B --> C["Specific knowledge pattern"]
    C --> D["Leverage vehicle"]
    D --> E["Compounding outputs"]
    ...
    D --> D1["Obsidian + Codex + trading journal + essays/tools"]
    E --> E1["Better judgment, reusable systems, public/private assets"]
```
...
```mermaid
flowchart LR
    A["Learning science"] --> E["AI-assisted capability building"]
    B["Trading / investing judgment"] --> E
    C["AI coding workflows"] --> E
    D["Writing / synthesis"] --> E
    F["Naval: specific knowledge + leverage"] --> E

    E --> G["Personal systems for learning, trading, building, and decision-making"]
```
...
```mermaid
flowchart TD
    A["Raw sources"] --> B["Source pages"]
    B --> C["Concept pages"]
    C --> D["Synthesis pages"]
    D --> E["Operating templates"]
    E --> F["Practice loops"]
    F --> G["Feedback and records"]
    G --> C
    G --> D

    E --> H["Trading journal"]
    E --> I["AI coding playbooks"]
    E --> J["Learning plans"]
    E --> K["Essays / public notes"]
```
