...
Most descriptions of [[concepts/critical-thinking|critical thinking]] make it sound like a vague virtue: be thoughtful, ask questions, avoid bias. That is too soft to be operational. The material in this wiki suggests a harder claim:
...
The practical guide in [[sources/critical-thinking-a-practical-guide-to-better-decision-making]] gives the outer loop:

1. define the real question
2. gather relevant evidence
3. test whether the evidence actually supports the claim
4. inspect consequences
5. compare alternative viewpoints
...
That is where the [[concepts/socratic-method|Socratic method]] and the fallacy cluster become more than supporting material. They reveal that critical thinking has two layers:
...
This is why [[concepts/problem-framing]] matters. A person asking "Should I do this?" is weaker than a person asking "What outcome am I actually trying to optimize, under what constraints, and by what evidence would I judge success?" Critical thinking starts by cleaning up the object of thought.

## Layer 2: Stress-Test the Reasoning

Once the question is clear, the reasoning must be interrogated. [[sources/this-tool-will-help-improve-your-critical-thinking]] shows why Socratic questioning is so durable: it turns passive belief into visible structure.
...
1. [[concepts/false-cause-fallacy]]: mistaking correlation, sequence, or association for cause
2. [[concepts/argument-from-ignorance]]: treating absence of disproof as proof
3. [[concepts/false-analogy]]: assuming similarity in one respect means sameness in the relevant respect
4. [[concepts/slippery-slope-fallacy]]: converting one possible chain into inevitability
5. [[concepts/middle-ground-fallacy]]: assuming the midpoint is automatically fair or true
6. [[concepts/circular-reasoning]]: smuggling the conclusion into the premises
